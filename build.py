#!/usr/bin/env python3
"""바로 GO — 수원시 출장마사지·홈타이 정적 사이트 빌드 스크립트.
...
규칙(자동 적용):
  ...
  - 모든 페이지에 WebPage·BreadcrumbList·Organization 구조화 데이터 자동 삽입
...
# 본문(요금 블록 제외) 고유 텍스트가 이 글자수 미만이면 자동 noindex.
# 지역·역·생활권 페이지는 페이지별 고유 본문 1,100자 이상을 목표로 한다.
MIN_INDEX_CHARS = 1100
...
def build_schema(page: dict, canonical: str) -> str:
    ...
    물리적 사업장 주소가 없는 방문형 서비스이므로 LocalBusiness 는 사용하지 않는다."""
    site_url = BASE_URL.rstrip("/")
    og_image = f"{site_url}/assets/og-image.png"

    # BreadcrumbList — 홈 + 페이지별 breadcrumb
    crumbs = [("홈", "/")] + [
        (label, href or ("/" + page["path"]))
        for label, href in (page.get("breadcrumb") or [])
    ]
    items = []
    for i, (label, href) in enumerate(crumbs, start=1):
        url = href if href.startswith("http") else site_url + href
        items.append({
            "@type": "ListItem",
            "position": i,
            "name": label,
    ...
    org = {
        ...
        "telephone": PHONE,
        "image": og_image,
        "areaServed": {"@type": "City", "name": "경기도 수원시"},
        "knowsAbout": ["출장마사지", "홈타이", "방문 관리 서비스"],
    }
    webpage = {
        "@type": "WebPage",
...
<header class="site-header">
  ...
  <div class="header-top">
    <div class="header-inner">
      ...
      <p class="header-tagline"><span class="tag-gem">◆</span> 수원시 전지역 방문 관리 <span class="tag-gem">◆</span> 24시간 상담</p>
...
<footer class="site-footer">
  <div class="container footer-grid">
    <div class="footer-col footer-about">
      ...
      <p class="footer-desc">수원시 전지역 방문 출장마사지·홈타이 안내 사이트입니다. 모든 서비스는 안내된 관리 범위와 위생·안전 기준 안에서만 제공됩니다.</p>
      <address class="footer-contact">
        ...
        <span class="footer-contact-row"><span class="footer-label">서비스 지역</span> 경기도 수원시 전지역</span>
      </address>
    ...
    <nav class="footer-col" aria-label="지역 안내">
      ...
      <ul>
        <li><a href="/gyeonggi/suwon/">구별 안내</a></li>
        <li><a href="/gyeonggi/suwon/areas/">지역별 안내</a></li>
        <li><a href="/gyeonggi/suwon/station/">역세권 안내</a></li>
        <li><a href="/gyeonggi/suwon/area/">생활권 안내</a></li>
      </ul>
    </nav>
    <nav class="footer-col" aria-label="이용 안내">
      <p class="footer-title">이용 안내</p>
      <ul>
        <li><a href="/gyeonggi/suwon/reservation/">예약 안내</a></li>
        <li><a href="/gyeonggi/suwon/check/">이용 전 확인사항</a></li>
        <li><a href="/gyeonggi/suwon/hometai-guide/">홈타이 이용 가이드</a></li>
        <li><a href="/gyeonggi/suwon/support/">고객센터</a></li>
        <li><a href="/gyeonggi/suwon/support/#faq">자주 묻는 질문</a></li>
      </ul>
    </nav>
    <nav class="footer-col" aria-label="정책 및 기준">
      <p class="footer-title">정책</p>
      <ul>
        <li><a href="/gyeonggi/suwon/about/">사이트 소개</a></li>
        <li><a href="/gyeonggi/suwon/privacy/">개인정보 처리방침</a></li>
        <li><a href="/gyeonggi/suwon/terms/">이용약관</a></li>
        <li><a href="/gyeonggi/suwon/check/#safety">고객 안전 안내</a></li>
        <li><a href="/gyeonggi/suwon/check/#privacy">개인정보 처리 기준</a></li>
      </ul>
    </nav>
  </div>
  <div class="footer-bottom">
    <div class="container footer-bottom-inner">
      ...
      <p class="footer-note">상호: {BRAND} · 전화예약 {PHONE_DISPLAY} · 건전한 방문 관리 서비스를 운영하며, 불법적인 요청은 어떤 경우에도 응하지 않습니다.</p>
    </div>
  </div>
</footer>
